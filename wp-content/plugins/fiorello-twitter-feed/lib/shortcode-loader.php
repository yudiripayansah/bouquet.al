...
class ShortcodeLoader {
    ...
    private function addShortcodes() {
	    $shortcodes_class_name = apply_filters('fiorello_twitter_filter_add_vc_shortcode', $shortcodes_class_name = array());
    ...
    public function load() {
    	if(fiorello_twitter_theme_installed()) {
		    $this->addShortcodes();
