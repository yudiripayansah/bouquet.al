...
class PortfolioProjectInfo implements Lib\ShortcodeInterface {
	...
	public function vcMap() {
		if ( function_exists( 'vc_map' ) ) {
			vc_map(
				array(
					'name'     => esc_html__( 'Mikado Portfolio Project Info', 'fiorello-core' ),
					'base'     => $this->getBase(),
					...
					'params'   => array(
						array(
							...
							'heading'     => esc_html__( 'Selected Project', 'fiorello-core' ),
							'settings'    => array(
								'sortable'      => true,
								'unique_values' => true
							),
							'description' => esc_html__( 'If you left this field empty then project ID will be of the current page', 'fiorello-core' )
						),
						array(
							'type'        => 'dropdown',
							'param_name'  => 'project_info_type',
							'heading'     => esc_html__( 'Project Info Type', 'fiorello-core' ),
							'value'       => array(
								esc_html__( 'Title', 'fiorello-core' )          => 'title',
								esc_html__( 'Category', 'fiorello-core' )       => 'category',
								esc_html__( 'Tag', 'fiorello-core' )            => 'tag',
								esc_html__( 'Author', 'fiorello-core' )         => 'author',
								esc_html__( 'Date', 'fiorello-core' )           => 'date',
								esc_html__( 'Featured Image', 'fiorello-core' ) => 'image'
							),
							'admin_label' => true
						),
						array(
							...
							'heading'     => esc_html__( 'Project Title Tag', 'fiorello-core' ),
							'value'       => array_flip( fiorello_mikado_get_title_tag( true, array( 'p' => 'p' ) ) ),
							'description' => esc_html__( 'Set title tag for project title element', 'fiorello-core' ),
							'dependency'  => array( 'element' => 'project_info_type', 'value' => array( 'title' ) )
						),
						array(
							'type'        => 'textfield',
							'param_name'  => 'project_info_title',
							'heading'     => esc_html__( 'Project Info Label', 'fiorello-core' ),
							'description' => esc_html__( 'Add project info label before project info element/s', 'fiorello-core' )
						),
						array(
							'type'       => 'dropdown',
							'param_name' => 'project_info_title_tag',
							'heading'    => esc_html__( 'Project Info Label Tag', 'fiorello-core' ),
							'value'      => array_flip( fiorello_mikado_get_title_tag( true, array( 'p' => 'p' ) ) ),
