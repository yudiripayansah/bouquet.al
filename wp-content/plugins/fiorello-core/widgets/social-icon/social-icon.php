...
class FiorelloMikadoSocialIconWidget extends FiorelloMikadoWidget {
	
	public function __construct() {
		parent::__construct(
			'mkdf_social_icon_widget',
			esc_html__( 'Mikado Social Icon Widget', 'fiorello-core' ),
			array( 'description' => esc_html__( 'Add social network icons to widget areas', 'fiorello-core' ) )
		);
	...
	protected function setParams() {
		$this->params = array_merge(
			fiorello_mikado_icon_collections()->getSocialIconWidgetParamsArray(),
			array(
				array(
					'type'  => 'textfield',
					'name'  => 'link',
	...
	public function widget( $args, $instance ) {
		...
		<a class="mkdf-social-icon-widget-holder mkdf-icon-has-hover" <?php echo fiorello_mikado_get_inline_attr( $hover_color, 'data-hover-color' ); ?> <?php fiorello_mikado_inline_style( $icon_styles ) ?> href="<?php echo esc_url( $link ); ?>" target="<?php echo esc_attr( $target ); ?>">
