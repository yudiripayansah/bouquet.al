...
<div class="mkdf-video-button-holder <?php echo esc_attr($holder_classes); ?>">
	...
	<?php } else { ?>
		<a class="mkdf-video-button-play" <?php echo fiorello_mikado_get_inline_style($play_button_styles); ?> href="<?php echo esc_url($video_link); ?>" target="_self" data-rel="prettyPhoto[video_button_pretty_photo_<?php echo esc_attr($rand); ?>]">
			<span class="mkdf-video-button-play-inner">
