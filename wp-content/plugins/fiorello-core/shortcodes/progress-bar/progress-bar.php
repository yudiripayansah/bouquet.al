<?php
namespace FiorelloCore\CPT\Shortcodes\ProgressBar;
...
class ProgressBar implements Lib\ShortcodeInterface {
	...
	public function vcMap() {
		if ( function_exists( 'vc_map' ) ) {
			vc_map(
				array(
					'name'                      => esc_html__( 'Mikado Progress Bar', 'fiorello-core' ),
					'base'                      => $this->base,
					...
					'params'                    => array(
						...
						array(
							...
							'heading'    => esc_html__( 'Percentage Type', 'fiorello-core' ),
							'value'      => array(
								esc_html__( 'Default', 'fiorello-core' )  => '',
								esc_html__( 'Floating', 'fiorello-core' ) => 'floating'
							),
						...
						array(
							...
							'heading'    => esc_html__( 'Active Color', 'fiorello-core' )
						),
						array(
							'type'       => 'colorpicker',
							'param_name' => 'color_inactive',
							'heading'    => esc_html__( 'Inactive Color', 'fiorello-core' )
						)
					)
				)
			);
	...
	public function render( $atts, $content = null ) {
		...
		$html = fiorello_core_get_shortcode_module_template_part( 'templates/progress-bar-template', 'progress-bar', '', $params );
