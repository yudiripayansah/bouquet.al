<?php
namespace FiorelloCore\CPT\Shortcodes\Process;
...
class Process implements Lib\ShortcodeInterface {
	...
	public function vcMap() {
		if ( function_exists( 'vc_map' ) ) {
			vc_map(
				array(
					'name'            => esc_html__( 'Mikado Process', 'fiorello-core' ),
					'base'            => $this->base,
					...
					'params'          => array(
						...
						array(
							...
							'value'       => array(
								esc_html__( '2 Columns', 'fiorello-core' ) => 'two',
								esc_html__( '3 Columns', 'fiorello-core' ) => 'three',
								esc_html__( '4 Columns', 'fiorello-core' ) => 'four'
							),
							'save_always' => true
						),
						array(
							...
							'value'       => array(
								esc_html__( 'Default None', 'fiorello-core' ) => '',
	...
	public function render( $atts, $content = null ) {
		...
		$html = fiorello_core_get_shortcode_module_template_part( 'templates/process-template', 'process', '', $params );
