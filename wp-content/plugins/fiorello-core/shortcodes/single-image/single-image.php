<?php
namespace FiorelloCore\CPT\Shortcodes\SingleImage;
...
class SingleImage implements Lib\ShortcodeInterface {
	...
	public function vcMap() {
		if ( function_exists( 'vc_map' ) ) {
			vc_map(
				array(
					'name'                      => esc_html__( 'Mikado Single Image', 'fiorello-core' ),
					'base'                      => $this->getBase(),
					...
					'params'                    => array(
						...
						array(
							...
							'value'      => array(
								...
								esc_html__( 'Moving on Hover', 'fiorello-core' )  => 'moving'
							)
						),
						array(
							'type'       => 'textfield',
	...
	public function render( $atts, $content = null ) {
		...
		$html = fiorello_core_get_shortcode_module_template_part( 'templates/single-image', 'single-image', '', $params );
