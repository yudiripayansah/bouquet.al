<?php
if ( ! function_exists( 'fiorello_mikado_init_google_fonts_array' ) ) {
	function fiorello_mikado_init_google_fonts_array() {
		...
		$fiorello_mikado_fonts_array = $google_fonts_decoded['items'];
	}
	add_action('after_setup_theme', 'fiorello_mikado_init_google_fonts_array');
}