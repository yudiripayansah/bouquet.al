...
if ( have_posts() ) : while ( have_posts() ) : the_post();
	...
	fiorello_mikado_include_blog_helper_functions( 'singles', 'standard' );
	
	//Action added for applying module specific filters that couldn't be applied on init
	do_action( 'fiorello_mikado_action_blog_single_loaded' );
	...
	<div class="<?php echo esc_attr( $mkdf_holder_params['holder'] ); ?>">
		...
		<div class="<?php echo esc_attr( $mkdf_holder_params['inner'] ); ?>">
			<?php fiorello_mikado_get_blog_single( 'standard' ); ?>
		</div>
