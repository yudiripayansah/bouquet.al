...
<div class="mkdf-full-width">
	...
	<div class="mkdf-full-width-inner">
        <?php do_action( 'fiorello_mikado_action_after_container_inner_open' ); ?>
		<?php if ( have_posts() ) : while ( have_posts() ) : the_post(); ?>
			<div class="mkdf-grid-row">
				<div <?php echo fiorello_mikado_get_content_sidebar_class(); ?>>
					<?php
						the_content();
						do_action( 'fiorello_mikado_action_page_after_content' );
					?>
				</div>
		...
		<?php endwhile; endif; ?>
        <?php do_action( 'fiorello_mikado_action_before_container_inner_close' ); ?>
	</div>
