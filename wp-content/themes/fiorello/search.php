<?php
$mkdf_search_holder_params = fiorello_mikado_get_holder_params_search();
?>
<?php get_header(); ?>
<?php fiorello_mikado_get_title(); ?>
<?php do_action('fiorello_mikado_action_before_main_content'); ?>
	<div class="<?php echo esc_attr( $mkdf_search_holder_params['holder'] ); ?>">
		...
		<div class="<?php echo esc_attr( $mkdf_search_holder_params['inner'] ); ?>">
			<?php fiorello_mikado_get_search_page(); ?>
		</div>
