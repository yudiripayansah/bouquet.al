<?php
namespace FiorelloCore\CPT\Shortcodes\BlogSlider;
...
class BlogSlider implements Lib\ShortcodeInterface {
	...
	public function vcMap() {
		vc_map(
			array(
				'name'                      => esc_html__( 'Mikado Blog Slider', 'fiorello' ),
				'base'                      => $this->base,
				...
				'params'                    => array(
					array(
						...
						'value'       => array(
							esc_html__( 'Slider', 'fiorello' )            => 'slider',
							esc_html__( 'Carousel', 'fiorello' )          => 'carousel',
							esc_html__( 'Carousel Centered', 'fiorello' ) => 'carousel-centered'
						),
						'save_always' => true
					),
					array(
	...
	public function render( $atts, $content = null ) {
		...
		fiorello_mikado_get_module_template_part( 'shortcodes/blog-slider/holder', 'blog', '', $params );
