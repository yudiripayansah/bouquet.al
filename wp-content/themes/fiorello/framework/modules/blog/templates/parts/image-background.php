...
$blog_list_image_id = ! empty( $image_meta ) && fiorello_mikado_blog_item_has_link() ? fiorello_mikado_get_attachment_id_from_url( $image_meta ) : '';
$background_image   = '';
...
?>
<?php if ( $has_featured ) { ?>
	<div class="mkdf-post-image-background" <?php fiorello_mikado_inline_style($background_image); ?>>
