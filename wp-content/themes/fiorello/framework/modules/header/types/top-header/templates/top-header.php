<?php
if($show_header_top) {
	do_action('fiorello_mikado_action_before_header_top');
	?>
	...
	<div class="mkdf-top-bar">
		<?php do_action( 'fiorello_mikado_action_after_header_top_html_open' ); ?>
		...
		<?php do_action( 'fiorello_mikado_action_before_header_top_html_close' ); ?>
	</div>
	
	<?php do_action('fiorello_mikado_action_after_header_top');
}