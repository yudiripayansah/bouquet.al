...
if ( ! function_exists( 'fiorello_mikado_get_title_types_options' ) ) {
	function fiorello_mikado_get_title_types_options() {
		$title_type_options = apply_filters( 'fiorello_mikado_filter_title_type_global_option', $title_type_options = array() );
		
		return $title_type_options;
	}
}

if ( ! function_exists( 'fiorello_mikado_get_title_type_default_options' ) ) {
	function fiorello_mikado_get_title_type_default_options() {
		$title_type_option = apply_filters( 'fiorello_mikado_filter_default_title_type_global_option', $title_type_option = '' );
...
if ( ! function_exists('fiorello_mikado_title_options_map') ) {
	function fiorello_mikado_title_options_map() {
		$title_type_options        = fiorello_mikado_get_title_types_options();
		$title_type_default_option = fiorello_mikado_get_title_type_default_options();
		...
		$panel_title = fiorello_mikado_add_admin_panel(
			array(
				'page' => '_title_page',
				'name' => 'panel_title',
				'title' => esc_html__('Title Settings', 'fiorello')
			)
		);
		...
		fiorello_mikado_add_admin_field(
			array(
				...
				'description'   => esc_html__( 'This option will enable/disable Title Area', 'fiorello' ),
				'parent'        => $panel_title
			)
		);
		
			$show_title_area_container = fiorello_mikado_add_admin_container(
				array(
					'parent'          => $panel_title,
				...
				fiorello_mikado_add_admin_field(
					...
					fiorello_mikado_add_admin_field(
						array(
							...
							'description'   => esc_html__( 'Specify title vertical alignment', 'fiorello' ),
							'parent'        => $show_title_area_container,
							'options'       => array(
		...
		do_action( 'fiorello_mikado_action_additional_title_area_options_map', $show_title_area_container );
		
		/***************** Additional Title Area Layout - end *****************/
		
		
		$panel_typography = fiorello_mikado_add_admin_panel(
			array(
				'page'  => '_title_page',
				'name'  => 'panel_title_typography',
				'title' => esc_html__( 'Typography', 'fiorello' )
			)
		);
			...
			$group_page_title_styles = fiorello_mikado_add_admin_group(
				array(
					'name'        => 'group_page_title_styles',
					'title'       => esc_html__( 'Title', 'fiorello' ),
					'description' => esc_html__( 'Define styles for page title', 'fiorello' ),
					'parent'      => $panel_typography
				)
			);
		
				$row_page_title_styles_1 = fiorello_mikado_add_admin_row(
					array(
				...
				$row_page_title_styles_2 = fiorello_mikado_add_admin_row(
					array(
				...
				$row_page_title_styles_3 = fiorello_mikado_add_admin_row(
					array(
			...
			fiorello_mikado_add_admin_section_title(
				array(
					...
					'title'  => esc_html__( 'Subtitle', 'fiorello' ),
					'parent' => $panel_typography
				)
			);
		
			$group_page_subtitle_styles = fiorello_mikado_add_admin_group(
				array(
					'name'        => 'group_page_subtitle_styles',
					'title'       => esc_html__( 'Subtitle', 'fiorello' ),
					'description' => esc_html__( 'Define styles for page subtitle', 'fiorello' ),
					'parent'      => $panel_typography
				)
			);
		
				$row_page_subtitle_styles_1 = fiorello_mikado_add_admin_row(
					array(
					...
					fiorello_mikado_add_admin_field(
						array(
							...
							'options' => fiorello_mikado_get_title_tag(false, array('span' => 'span')),
							'parent' => $row_page_subtitle_styles_1
						)
					);
		
				$row_page_subtitle_styles_2 = fiorello_mikado_add_admin_row(
					array(
				...
				$row_page_subtitle_styles_3 = fiorello_mikado_add_admin_row(
					array(
		...
		do_action( 'fiorello_mikado_action_additional_title_typography_options_map', $panel_typography );
		
		/***************** Additional Title Typography Layout - end *****************/
    }

	add_action( 'fiorello_mikado_action_options_map', 'fiorello_mikado_title_options_map', 6);
}