<div class="mkdf-fullscreen-search-holder">
	<a <?php fiorello_mikado_class_attribute( $search_close_icon_class ); ?> href="javascript:void(0)">
					...
					<div class="mkdf-form-holder">
						<div class="mkdf-form-holder-inner">
							<div class="mkdf-field-holder">
								<input type="text" placeholder="<?php esc_attr_e( 'Search for...', 'fiorello' ); ?>" name="s" class="mkdf-search-field" autocomplete="off"/>
							</div>
