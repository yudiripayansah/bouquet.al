...
if ( ! function_exists( 'fiorello_mikado_add_linear_icon_pack' ) ) {
	function fiorello_mikado_add_linear_icon_pack( $iconCollections ) {
		$iconCollections['linear_icons'] = new FiorelloMikadoLinearIcons( 'Linear Icons', 'linear_icon' );
		
		return $iconCollections;
	}
	
	add_filter( 'fiorello_mikado_filter_add_icon_pack_into_collection', 'fiorello_mikado_add_linear_icon_pack' );
}

if ( ! function_exists( 'fiorello_mikado_add_linear_icon_pack_option' ) ) {
	function fiorello_mikado_add_linear_icon_pack_option( $options ) {
		$options['linear_icons'] = esc_html__( 'Linear Icons', 'fiorello' );
		
		return $options;
	}
	
	add_filter( 'fiorello_mikado_filter_add_icon_pack_into_options', 'fiorello_mikado_add_linear_icon_pack_option' );
}

class FiorelloMikadoLinearIcons implements iFiorelloMikadoIconCollection {
	public $icons;
	public $title;
	public $param;
	public $styleUrl;
