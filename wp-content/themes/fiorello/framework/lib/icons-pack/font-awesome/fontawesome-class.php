...
if ( ! function_exists( 'fiorello_mikado_add_font_awesome_icon_pack' ) ) {
	function fiorello_mikado_add_font_awesome_icon_pack( $iconCollections ) {
		$iconCollections['font_awesome'] = new FiorelloMikadoIconsFontAwesome( 'Font Awesome', 'fa_icon' );
		
		return $iconCollections;
	}
	
	add_filter( 'fiorello_mikado_filter_add_icon_pack_into_collection', 'fiorello_mikado_add_font_awesome_icon_pack' );
}

if ( ! function_exists( 'fiorello_mikado_add_font_awesome_icon_pack_option' ) ) {
	function fiorello_mikado_add_font_awesome_icon_pack_option( $options ) {
		$options['font_awesome'] = esc_html__( 'Font Awesome', 'fiorello' );
		
		return $options;
	}
	
	add_filter( 'fiorello_mikado_filter_add_icon_pack_into_options', 'fiorello_mikado_add_font_awesome_icon_pack_option' );
	add_filter( 'fiorello_mikado_filter_add_icon_pack_into_social_options', 'fiorello_mikado_add_font_awesome_icon_pack_option' );
}

class FiorelloMikadoIconsFontAwesome implements iFiorelloMikadoIconCollection {
	public $icons;
	public $title;
	public $param;
	public $styleUrl;
