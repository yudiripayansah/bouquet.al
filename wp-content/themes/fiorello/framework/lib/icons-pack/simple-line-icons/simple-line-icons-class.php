...
if ( ! function_exists( 'fiorello_mikado_add_simple_line_icon_pack' ) ) {
	function fiorello_mikado_add_simple_line_icon_pack( $iconCollections ) {
		$iconCollections['simple_line_icons'] = new FiorelloMikadoSimpleLineIcons( 'Simple Line Icons', 'simple_line_icon' );
		
		return $iconCollections;
	}
	
	add_filter( 'fiorello_mikado_filter_add_icon_pack_into_collection', 'fiorello_mikado_add_simple_line_icon_pack' );
}

if ( ! function_exists( 'fiorello_mikado_add_simple_line_icon_pack_option' ) ) {
	function fiorello_mikado_add_simple_line_icon_pack_option( $options ) {
		$options['simple_line_icons'] = esc_html__( 'Simple Line Icons', 'fiorello' );
		
		return $options;
	}
	
	add_filter( 'fiorello_mikado_filter_add_icon_pack_into_options', 'fiorello_mikado_add_simple_line_icon_pack_option' );
	add_filter( 'fiorello_mikado_filter_add_icon_pack_into_social_options', 'fiorello_mikado_add_simple_line_icon_pack_option' );
}

class FiorelloMikadoSimpleLineIcons implements iFiorelloMikadoIconCollection {
    public $icons;
    public $title;
    public $param;
    public $styleUrl;
    ...
    public function setSocialIconsArray() {
        $this->socialIcons = array(
            ''                        => '',
            'icon-social-behance'     => esc_html__('Behance', 'fiorello'),
            'icon-social-dribbble'    => esc_html__('Dribbble', 'fiorello'),
            'icon-social-dropbox'     => esc_html__('Dropbox', 'fiorello'),
            'icon-social-facebook'    => esc_html__('Facebook', 'fiorello'),
            'icon-social-foursquare'  => esc_html__('Foursquare', 'fiorello'),
            'icon-social-github'      => esc_html__('Github', 'fiorello'),
            'icon-social-gplus'       => esc_html__('Google Plus', 'fiorello'),
            'icon-social-instagram'   => esc_html__('Instagram', 'fiorello'),
            'icon-social-linkedin'    => esc_html__('LinkedIn', 'fiorello'),
            'icon-social-pintarest'   => esc_html__('Pinterest', 'fiorello'),
            'icon-social-reddit'      => esc_html__('Reddit', 'fiorello'),
            'icon-social-skype'       => esc_html__('Skype', 'fiorello'),
            'icon-social-soundcloud'  => esc_html__('Soundcloud', 'fiorello'),
            'icon-social-stumbleupon' => esc_html__('Stumbleupon', 'fiorello'),
            'icon-social-spotify'     => esc_html__('Spotify', 'fiorello'),
            'icon-social-tumblr'      => esc_html__('Tumblr', 'fiorello'),
            'icon-social-twitter'     => esc_html__('Twitter', 'fiorello'),
            'icon-social-youtube'     => esc_html__('Youtube', 'fiorello')
        );
    }
