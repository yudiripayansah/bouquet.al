...
if ( ! function_exists( 'fiorello_mikado_add_linea_icon_pack' ) ) {
	function fiorello_mikado_add_linea_icon_pack( $iconCollections ) {
		$iconCollections['linea_icons'] = new FiorelloMikadoLineaIcons( 'Linea Icons', 'linea_icon' );
		
		return $iconCollections;
	}
	
	add_filter( 'fiorello_mikado_filter_add_icon_pack_into_collection', 'fiorello_mikado_add_linea_icon_pack' );
}

if ( ! function_exists( 'fiorello_mikado_add_linea_icon_pack_option' ) ) {
	function fiorello_mikado_add_linea_icon_pack_option( $options ) {
		$options['linea_icons'] = esc_html__( 'Linea Icons', 'fiorello' );
		
		return $options;
	}
	
	add_filter( 'fiorello_mikado_filter_add_icon_pack_into_options', 'fiorello_mikado_add_linea_icon_pack_option' );
}

class FiorelloMikadoLineaIcons implements iFiorelloMikadoIconCollection {
	public $icons;
	public $title;
	public $param;
	public $styleUrl;
