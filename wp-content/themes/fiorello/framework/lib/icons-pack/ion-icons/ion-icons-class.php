...
if ( ! function_exists( 'fiorello_mikado_add_ion_icon_pack' ) ) {
	function fiorello_mikado_add_ion_icon_pack( $iconCollections ) {
		$iconCollections['ion_icons'] = new FiorelloMikadoIonIcons( 'Ion Icons', 'ion_icon' );
		
		return $iconCollections;
	}
	
	add_filter( 'fiorello_mikado_filter_add_icon_pack_into_collection', 'fiorello_mikado_add_ion_icon_pack' );
}

if ( ! function_exists( 'fiorello_mikado_add_ion_icon_pack_option' ) ) {
	function fiorello_mikado_add_ion_icon_pack_option( $options ) {
		$options['ion_icons'] = esc_html__( 'Ion Icons', 'fiorello' );
		
		return $options;
	}
	
	add_filter( 'fiorello_mikado_filter_add_icon_pack_into_options', 'fiorello_mikado_add_ion_icon_pack_option' );
	add_filter( 'fiorello_mikado_filter_add_icon_pack_into_social_options', 'fiorello_mikado_add_ion_icon_pack_option' );
}

class FiorelloMikadoIonIcons implements iFiorelloMikadoIconCollection {
	public $icons;
	public $socialIcons;
    public $title;
	public $param;
