...
if ( ! function_exists( 'fiorello_mikado_add_dripicons_icon_pack' ) ) {
	function fiorello_mikado_add_dripicons_icon_pack( $iconCollections ) {
		$iconCollections['dripicons'] = new FiorelloMikadoDripicons( 'Dripicons', 'dripicon' );
		
		return $iconCollections;
	}
	
	add_filter( 'fiorello_mikado_filter_add_icon_pack_into_collection', 'fiorello_mikado_add_dripicons_icon_pack' );
}

if ( ! function_exists( 'fiorello_mikado_add_dripicons_icon_pack_option' ) ) {
	function fiorello_mikado_add_dripicons_icon_pack_option( $options ) {
		$options['dripicons'] = esc_html__( 'Dripicons', 'fiorello' );
		
		return $options;
	}
	
	add_filter( 'fiorello_mikado_filter_add_icon_pack_into_options', 'fiorello_mikado_add_dripicons_icon_pack_option' );
}

class FiorelloMikadoDripicons implements iFiorelloMikadoIconCollection {
    public $icons;
    public $title;
    public $param;
    public $styleUrl;
	...
	public function getDropdownCartIcon() {
		return $this->render('dripicons-shopping-bag');
	}
