...
if ( ! function_exists( 'fiorello_mikado_add_font_elegant_icon_pack' ) ) {
	function fiorello_mikado_add_font_elegant_icon_pack( $iconCollections ) {
		$iconCollections['font_elegant'] = new FiorelloMikadoIconsFontElegant( 'Font Elegant', 'fe_icon' );
		
		return $iconCollections;
	}
	
	add_filter( 'fiorello_mikado_filter_add_icon_pack_into_collection', 'fiorello_mikado_add_font_elegant_icon_pack' );
}

if ( ! function_exists( 'fiorello_mikado_add_font_elegant_icon_pack_option' ) ) {
	function fiorello_mikado_add_font_elegant_icon_pack_option( $options ) {
		$options['font_elegant'] = esc_html__( 'Font Elegant', 'fiorello' );
		
		return $options;
	}
	
	add_filter( 'fiorello_mikado_filter_add_icon_pack_into_options', 'fiorello_mikado_add_font_elegant_icon_pack_option' );
	add_filter( 'fiorello_mikado_filter_add_icon_pack_into_social_options', 'fiorello_mikado_add_font_elegant_icon_pack_option' );
}

class FiorelloMikadoIconsFontElegant implements iFiorelloMikadoIconCollection {
	public $icons;
	public $title;
	public $param;
	public $styleUrl;
